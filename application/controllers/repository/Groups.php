...
class Groups extends Admin_Controller 
{
	...
	*/
	public function index()
	{
		...
		$this->render_template('repository/groups/index', $this->data);
	}	
	...
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	if($create == true) {
        		...
        		redirect('repository/groups/', 'refresh');
        	}
        	else {
        		$this->session->set_flashdata('errors', 'Error occurred!!');
        		redirect('repository/groups/create', 'refresh');
        	}
        }
        else {
            // false case
            $this->render_template('repository/groups/create', $this->data);
        }	
	}
		...
		if($id) {
			...
			if ($this->form_validation->run() == TRUE) {
	        	...
	        	if($update == true) {
	        		...
	        		$this->session->set_flashdata('errors', 'Error occurred!!');
	        		redirect('repository/groups/edit/'.$id, 'refresh');
	        	}
	        }
	        else {
	            // false case
				...
				$this->render_template('repository/groups/edit', $this->data);	
	        }	
		}
	}
			...
			if($this->input->post('confirm')) {
				...
				if($check == true) {
					...
					if($delete == true) {
		        		...
		        		redirect('repository/groups/delete/'.$id, 'refresh');
		        	}
				}	
			}	
			else {
				$this->data['id'] = $id;
				$this->render_template('repository/groups/delete', $this->data);
			}	
		}
	}
