...
class Products extends Admin_Controller 
{
	public function __construct()
	{
		...
		$this->load->model('repository/model_brands');
		$this->load->model('repository/model_category');
		$this->load->model('repository/model_stores');
		$this->load->model('repository/model_attributes');
	}
	...
	public function fetchProductData()
	{
		...
		foreach ($data as $key => $value) {
            ...
            if(in_array('updateProduct', $this->permission)) {
    			$buttons .= '<a href="'.base_url('repository/products/update/'.$value['id']).'" class="btn btn-default"><i class="fa fa-pencil"></i></a>';
            }
	...
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	if($create == true) {
        		...
        		redirect('repository/products/', 'refresh');
        	}
        	else {
        		$this->session->set_flashdata('errors', 'Error occurred!!');
        		redirect('repository/products/create', 'refresh');
        	}
        }
        else {
            // false case
            ...
            $this->render_template('repository/products/create', $this->data);
        }	
	}
