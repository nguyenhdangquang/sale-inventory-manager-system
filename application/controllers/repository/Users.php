...
class Users extends Admin_Controller 
{
	...
	public function index()
	{
		...
		$this->render_template('repository/users/index', $this->data);
	}
	...
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	if($create == true) {
        		...
        		redirect('repository/users/create', 'refresh');
        	}
        }
        else {
            // false case
            ...
            $this->render_template('repository/users/create', $this->data);
        }	
		...
		if($id) {
			...
			if ($this->form_validation->run() == TRUE) {
		        ...
		        if(empty($this->input->post('password')) && empty($this->input->post('cpassword'))) {
		        	...
		        	if($update == true) {
		        		$this->session->set_flashdata('success', 'Successfully updated');
		        		redirect('repository/users/setting/', 'refresh');
		        	}
		        	else {
		        		$this->session->set_flashdata('errors', 'Error occurred!!');
		        		redirect('repository/users/setting/', 'refresh');
					...
					if($this->form_validation->run() == TRUE) {
						...
						$this->render_template('repository/users/setting', $this->data);	
			        }	
